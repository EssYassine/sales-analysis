...
def main():
    ...
    with PdfPages("../output/reports/rapport_statistiques.pdf") as pdf:
        ...
        print(f"Q1 : {q1['title']}\n", result1)
        fn.save_table_image(result1, q1["title"], "../output/tables/Q1.png")
        #fn.save_table_image(result1, q1["title"], pdf)
        ...
        print(f"\nQ2 : {q2['title']}\n", result2)
        fn.save_table_image(result2, q2["title"], "../output/tables/Q2.png")
        ...
        print(f"\nQ3 : {q3['title']}\n", result3)
        fn.save_table_image(result3, q3["title"], "../output/tables/Q3.png")
        ...
        print(f"\nQ4 : {q4['title']}\n", result4)
        #fn.save_table_image(result4, q4["title"], "../output/tables/Q4.png")
        ...
        print(f"\nQ5 : {q5['title']}\n", result5)
        fn.save_table_image(result5, q5["title"], "../output/tables/Q5.png")
        ...
        print(f"\nQ6 : {q6['title']}\n", result6)
        fn.save_table_image(result6, q6["title"], "../output/tables/Q6.png")
        ...
        print(f"\nQ7 : {q7['title']}\n", result7)
        fn.save_table_image(result7, q7["title"], "../output/tables/Q7.png")
    ...
    #print("\nPDF généré : rapport_statistiques.pdf")
